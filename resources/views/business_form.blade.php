			...
			<div class="top-menu">
				<div class="container">
					<div class="topbar">
						...
						<div class="left">
							<a href="{{url('residential')}}" style="text-decoration: none; color: #004E5B;">Residential</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="{{url('business')}}" style="text-decoration: none; color: #004E5B;">Business</a>
						</div>
						<div class="middle"></div>
						<div class="right">
							<ul>
								<li class="r"><a  href="mailto:info@linkbroadbands.com"  style="text-decoration: none; color: #004E5B;" target="_blank" rel="noopener noreferrer">info@linkbroadbands.com</a></li>
								<li class="r"><a href="tel:033 0174 1444" style="text-decoration: none; color: #004E5B;">033 0174 1444</a></li>
								<li class="r"><a href="{{url('faq')}}" style="text-decoration: none; color: #004E5B;">Help</a></li>
								<li class="r"><a href="{{url('faq')}}" style="text-decoration: none; color: #004E5B;">FAQ</a></li>
								<li ><a href="{{url('news')}}" style="text-decoration: none; color: #004E5B;">News</a></li>
							</ul>
						</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								<li class="has-dropdown"><a href="#" style="text-decoration: none; color: #004E5B;">Broadband</a>
									<ul class="dropdown">
								...
								<li class="has-dropdown"><a href="#" style="text-decoration: none; color: #004E5B;">Voice</a>
									<ul class="dropdown">
								...
								<li class="has-dropdown"><a href="#" style="text-decoration: none; color: #004E5B;">Mobile</a>
									<ul class="dropdown">
								...
								<li >
									<a href="{{url('hardware')}}" style="text-decoration: none; color: #004E5B;">Deals</a>
									
								</li>

								<li class="btn-cta"><a href="{{url('form')}}"><span>Get Started</span></a></li>
                            ...
                            <form class="form-register" id="broadband-form" method="" action="" role="form"
                                ...
                                <!-- SECION-1 -->
                                    <div class="form-section">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="" class="form-control input-sm" id="postcode" name="postcodes">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="radio">
                                                ...
                                                <!--<input type="radio" name="customer" value="new_customer">-->
                                                    ...
                                                    <b>New Connection / Migration Connection</b> - <b>£168 Inc VAT</b><br>
                                                    <p>I am a new customer in this property and have no working service</p>
                                                </label>
                                            </div>
                                                            ...
                                                            <tr>
                                                                <div class="form-row">
                                                                    <td>
                                                                        <div class="form-check" >                                                                            
                                                                            <input type="radio" name="broadband_plan" class="brd_plan"
                                                                                   value="Link Fast Fibre 80 (80 download |20 Upload |unlimited)- £38.75" 
                                                                                   data-name="Link Fast Fibre 80" data-price="38.75"> 
                                                                            <label class="form-check-label" for="credit">                                                                           
                                                                                <span> 
                                                                                    <b>Link Fast Fibre 80 - £38.75  Inc VAT </b> per month
                                                                                    <br>
                                                                                    <span style="color: gray; font-size: 12px;">80 download |20 Upload |unlimited</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                        <input type="radio" name="broadband_plan" class="brd_plan"
                                                                            value="Link Fast Fibre 100 (100 download |20 Upload |unlimited) - £40.50" 
                                                                            data-name="Link Fast Fibre 100" data-price="40.50"> 
                                                                        <label class="form-check-label" for="credit">                                                                           
                                                                                <span> 
                                                                                    <b>Link Fast Fibre 100 - £40.50Inc VAT </b> per month
                                                                                    <br>
                                                                                    <span style="color: gray; font-size: 12px;">100 download |20 Upload |unlimited</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                            ...
                                                            <tr>
                                                                <div class="form-row">
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <input type="radio" name="broadband_plan" class="brd_plan" 
                                                                                value="Link Superfast Fibre 115 (115 download |15 Upload |unlimited) - £40.75" 
                                                                                data-name="Link Superfast Fibre 115" data-price="40.75">
                                                                            <label class="form-check-label" for="credit">
                                                                                <span>
                                                                                    <b>Link Superfast Fibre 115 - £40.75Inc VAT</b> per month
                                                                                    <br>
                                                                                    <span style="color: gray; font-size: 12px;">115 download |15 Upload |unlimited</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <input type="radio" name="broadband_plan" class="brd_plan" 
                                                                                value="Link Superfast Fibre 120 (120 download |24 Upload |unlimited) - £41.25" 
                                                                                data-name="Link Superfast Fibre 120" data-price="41.25">
                                                                            <label class="form-check-label" for="credit">
                                                                                <span>
                                                                                    <b>Link Superfast Fibre 120 - £41.25Inc VAT</b> per month
                                                                                    <br>
                                                                                    <span style="color: gray; font-size: 12px;">120 download |24 Upload |unlimited</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                            ...
                                                            <tr>
                                                                <div class="form-row">
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <input type="radio" name="broadband_plan" class="brd_plan" 
                                                                                value="Link UltraFast Fibre 300 (300 download |30 Upload |unlimited) - £56.99" 
                                                                                data-name="Link UltraFast Fibre 300" data-price="56.99">
                                                                            <label class="form-check-label" for="credit">
                                                                                <span>
                                                                                    <b>Link UltraFast Fibre 300 - £56.99Inc VAT</b> per month
                                                                                    <br>
                                                                                    <span style="color: gray; font-size: 12px;">300 download |30 Upload |unlimited</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <input type="radio" name="broadband_plan" class="brd_plan" 
                                                                                value="Link Ultra-Fast Fibre 300 (360 download |72 Upload |unlimited) - £59.50" 
                                                                                data-name="Link UltraFast Fibre 300" data-price="59.50">
                                                                            <label class="form-check-label" for="credit">
                                                                                <span>
                                                                                    <b> Link UltraFast Fibre 360 - £59.50Inc VAT</b> per month
                                                                                    <br>
                                                                                    <span style="color: gray; font-size: 12px;">360 download |72 Upload |unlimited</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                            ...
                                                            <tr>
                                                                <div class="form-row">
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <input type="radio" name="broadband_plan" class="brd_plan" 
                                                                                value="Link UltraFast Fibre 300 (300 download |150 Upload |unlimited) - £60.25" 
                                                                                data-name="Link UltraFast Fibre 300" data-price="60.25">
                                                                            <label class="form-check-label" for="credit">
                                                                                <span>
                                                                                    <b> Link UltraFast Fibre 300 - £60.25Inc VAT</b> per month
                                                                                    <br>
                                                                                    <span style="color: gray; font-size: 12px;">300 download |150 Upload |unlimited</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <input type="radio" name="broadband_plan" class="brd_plan" 
                                                                                value="Link UltraFast Fibre 360 (360 download |180 Upload |unlimited) - £62.99" 
                                                                                data-name="Link UltraFast Fibre 360" data-price="62.99">
                                                                            <label class="form-check-label" for="credit">
                                                                                <span>
                                                                                    <b> Link UltraFast Fibre 360 - £62.99Inc VAT</b> per month
                                                                                    <br>
                                                                                    <span style="color: gray; font-size: 12px;">360 download |180 Upload |unlimited</span>
                                                                                </span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                    ...
                                    <div id="s" style="display:none;">
                                        ...
                                        <label style="padding:20px; padding-left:12px; padding-right: 12px; padding-top:10px; text-align:justify; font-weight: normal;">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <label style="text-align:justify;vertical-align: bottom; font-weight: normal;">Transfer You Number</label>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                        ...
                                        <table class="table tablepack">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="padding-top: 4px;padding-bottom: 4px;">
                                                        <div class="form-check">
                                                            <input type="radio" id="voice1" name="voice_package" 
                                                                value="Essentials - £7.99" data-name="Voice Plan Essentials" 
                                                                data-price="7.99" class="form-check-input" onclick="transfernoDiv()">
                                                            <label class="form-check-label" for="credit">
                                                                <b>Essentials £7.99 Incl.Vat</b> per month
                                                                <br>
                                                                <span>Same as broadband contract</span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding-top: 4px;padding-bottom: 4px;">
                                                        <div class="form-check">
                                                            <input type="radio" id="voice2" name="voice_package" 
                                                                value="Standard - £14.99" data-name="Voice Plan Standard" 
                                                                data-price="14.99" class="form-check-input" onclick="transfernoDiv()">
                                                            <label class="form-check-label" for="credit">
                                                                <b>Standard £14.99 Incl.Vat</b> per month
                                                                <br>
                                                                <span>Same as broadband contract</span>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td style="padding-top: 4px;padding-bottom: 4px;">
                                                    <div class="form-check">
                                                            <input type="radio" id="voice3" name="voice_package" 
                                                                value="Premium - £23.98" data-name="Voice Plan Premium" 
                                                                data-price="23.98" class="form-check-input" onclick="transfernoDiv()">
                                                            <label class="form-check-label" for="credit">
                                                                <b>Premium £23.98 Incl.Vat</b> per month
                                                                <br>
                                                                <span>Same as broadband contract</span>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td style="padding-top: 4px;padding-bottom: 4px;">
                                                    <div class="form-check">
                                                            <input type="radio" id="voice4" name="voice_package" 
                                                                value="Ultimate - £24.99" data-name="Voice Plan Ultimate" 
                                                                data-price="22.99" class="form-check-input" onclick="transfernoDiv()">
                                                            <label class="form-check-label" for="credit">
                                                                <b>Ultimate £24.99 Incl.Vat</b> per month
                                                                <br>
                                                                <span>Same as broadband contract</span>
                                                            </label>
                                                        </div>
                                ...
                                <h3>Router</h3>
                                    ...
                                    <table class="t table-router" style="box-shadow: none;">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h5 style="background-color:#00C1BD;color:white;">Optional Extras</h5>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" name="router_extraT" id="re1" 
                                                                    value="Meraki Go Complete Indoor WiFi Access Point + Router/Firewall + Wired Switch" 
                                                                    data-name="Meraki Go Complete Indoor WiFi Access Point + Router/Firewall + Wired Switch"
                                                                    data-price="81.99" onchange="valueChanged()">
                                                            <label class="form-check-label" for="same-address">Meraki Go Complete Indoor WiFi Access Point + Router/Firewall + Wired Switch</label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" name="router_extraT" id="re2" 
                                                                    value="Meraki Go - Indoor WiFi Access Point" 
                                                                    data-name="Meraki Go"
                                                                    data-price="120.00" onchange="valueChanged()">
                                                            <label class="form-check-label" for="same-address">Meraki Go - Indoor WiFi Access Point £120.00</label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" name="router_extraT" id="re3" 
                                                                    value="Cisco Meraki Go - 5 Port Security Gateway" 
                                                                    data-name="Cisco Meraki Go"
                                                                    data-price="150.00" onchange="valueChanged()">
                                                            <label class="form-check-label" for="same-address">Cisco Meraki Go - 5 Port Security Gateway £150.00</label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" name="router_extraT" id="re4" 
                                                                    value="Cisco GS110-8P-HW-UK Meraki Go - 8 Port POE Switch" 
                                                                    data-name="Cisco GS110-8P-HW-UK Meraki Go"
                                                                    data-price="120.00" onchange="valueChanged()">
                                                            <label class="form-check-label" for="same-address">Cisco GS110-8P-HW-UK Meraki Go - 8 Port POE Switch</label>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="t table-router" style="box-shadow: none;">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h5 style="background-color:#00C1BD;color:white;">Optional Routers</h5>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" name="router_extra[]" id="re5" 
                                                                value="DrayTek 2865 Vigor Dual-WAN ADSL+/VDSL2 Broadband Router w/ Load Balancing, VPN & 3G/4G LTE Support" 
                                                                data-price="120.00" data-name="DrayTek 2865 Vigor Dual-WAN ADSL+/VDSL2 Broadband Router w/ Load Balancing, VPN & 3G/4G LTE Support" 
                                                                onchange="valueChanged5()">
                                                                <label class="form-check-label" for="same-address">DrayTek 2865 Vigor Dual-WAN ADSL+/VDSL2 Broadband Router w/ Load Balancing, VPN & 3G/4G LTE Support</label>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" name="router_extra[]" id="re6" 
                                                                value="Modem Router Tp Link Dual Band Gigabit VoIP EVDSL" data-price="120.00" 
                                                                data-name="Modem Router Tp Link Dual Band Gigabit VoIP EVDSL" onchange="valueChanged6()">
                                                            <label class="form-check-label" for="same-address">Modem Router Tp Link Dual Band Gigabit VoIP EVDSL</label>
                                                        </div>
                                                    </td>
                                                </tr>                                               
                                            </tbody>
                                        ...
                                        <table class="t table-router" style="box-shadow: none;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" name="managed_router" id="re11" 
                                                                class="extrRouter" value="Managed router installation 70.00" 
                                                                data-price="70.00" data-name="Router Installation" onchange="installation()">
                                    ...
                                    <div class="">
                                        ...
                                        <br>
                                        <h5 style="background-color:#00C1BD;color:white;">News & Community Events</h5>
                                        <label style="padding:20px;padding-left:12px;padding-right: 12px;padding-top:10px;text-align:justify; font-weight: 400;">
                                ...
                                <tr class="space-row">
                                    ...
                                    <td class="ttt"><input type="textarea" name="billing_notes" class="form-control" id="note">
                                        <span style="color:#6F6F6F;font-size:14px;">* Migration customer : 30 days to move seamlessly from the current supplier.</span>
                                    </td>
                                </tr>
                                <tr class="space-row">
                ...
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12" style="margin-left:10px;width:100%;margin-top:30px;margin-right:10px;">
                    ...
                    <ul class="list-group " id="sidetab">
                            ...
                            <table id="product-details" style="box-shadow:none;background-color:white;border-collapse: collapse;border:none;font-size:13px;">
                                ...
                                <tbody id="order_summary">
                                    <tr id="connection_plan">
                                        ...
                                        <td class="row2 td-content">£168.00</td>
                                    </tr>
                                    <tr id="bb_plan"></tr>
                                    <tr id="vv_plan"></tr>
                        ...
                        <span style="text-align: center; margin-bottom: 20px;">
                                    <button type="submit" id="formSubmit" class="btn btn-info">Stripe </button>
                                    <button type="submit" id="GoCardlessformSubmit" class="btn btn-info">Go Cardless </button>
                            </span>
    </div>
                    </ul>
                </div>
...
$(document).ready(function(){
        ...
        $('#formSubmit').on('click',function(e){
               ...
               var orderDueDetails = getOrderDueDetails();
                ...
                $.ajax({
                    url: "/Business-Broadband-form-Submit",
                    type:"POST",
                    data:{
                        "_token": "{{ csrf_token() }}",
                        ...formData

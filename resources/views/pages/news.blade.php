...
<body>
    ...
    <div id="page">
        <nav class="fh5co-nav" role="navigation">
            ...
            <div class="top-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-2">
                            <div id="fh5co-logo"><a href="{{route('news')}}"><img src="assets/images/logo1.png" style="width:120px;height:68px;"></a></div>
                        </div>
        ...
        <div class="container-fluid" id="lap">
            <div class="row">
                <div class="col-lg-12 ">
                    <img class="shapecon3" src="assets/images/newsheader.jpg" style="display:block;width:100%;height: auto;vertical-align:bottom;">
                </div>
            </div>
        </div>
        <div class="container" id="mob">
            <div class="row">
                <div class="col-lg-12 ">
                    <img src="assets/images/newsheader.jpg" style="display:block;width:100%;height: auto;vertical-align:bottom;">
                </div>
            </div>
        </div>

                ...
                <div class="topbar">
                    <div class="left">
                        <div class="col-md-6 col-xs-6 col-sm-12">
                            <a href="{{url('residential')}}" style="text-decoration: none; cursor: pointer; color: #004E5B;">Residential</a>
                        </div>
                        <div class="col-md-6 col-xs-6 col-sm-12">
                            <a href="{{url('business')}}" style="text-decoration: none; cursor: pointer; color: #004E5B;">Business </a>
                        </div>
                    </div>
                    <div class="middle"></div>
                    <div class="right">
                        <ul>
                            <li class="r"><a href="mailto:info@linkbroadbands.com"  style="text-decoration: none; color: #004E5B;"target="_blank"
                            ...
                            <li class="r"><a href="{{url('contact-us')}}" style="text-decoration: none; color: #004E5B;">Help</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-10">
                        ...
                        <ul>
                            ...
                            <li class="has-dropdown"><a href="mobileresidential.html" style="text-decoration: none; color: #004E5B;">Mobile</a>
									<ul class="dropdown">
...
function getOrderDueDetails() {
    ...
    return result;
        ...
        var getRemanningDays = function() {
            var acvdate=document.getElementById("acvdate").value;
            var date = new Date(acvdate);
